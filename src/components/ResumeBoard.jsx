...
export default function ResumeBoard() {
    ...
    const experienceArray = [
        {"Infios": {"duration" : "06.2023 - current", "position": "software engineer / wms admin", "prompts" : [
        ...
        {"Foursquare": {"duration" : "06.2022 - 09.2022", "position": "software engineer intern", "prompts" : [
        ...
        {"Western Washington University": {"duration" : "06.2021 - 07.2022", "position": "graduate teaching assistant, computer science department", "prompts" : [
        ...
        {"Western Washington University": {"duration" : "01.2018 - 07.2022", "position": "front desk representative, office of admissions", "prompts" : [
        ...
        "link": "https://www.wwu.edu"}},
        {"Coding with Kids": {"duration" : "06.2018 - 09.2019", "position": "coding instructor / manager", "prompts" : [],
                ...
                <div className="resumeboard-experience-wrapper">
                    {experienceArray.map((entry, index) => {
                        ...
                        <div key={index} className="experience-section">
                            ...
                            <h3 className="experience-company">{<TypewriterText text={company}/>}</h3>
                            <span className="experience-duration">{<TypewriterText text={details.duration}/>}</span>
                            </div>
                            <div className="experience-position">{<TypewriterText text={details.position}/>}</div>
